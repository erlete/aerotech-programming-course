...
const stepSlider = {
    ...
    installation_description: `Follow the installer procedure and <b>make sure to check all the "Other" options</b>: <ul class="mt-2"><li><input onclick="return false;" checked=true type="checkbox" name="step-1" class="w-4 h-4 m-2 text-indigo-800 bg-gray-300 border-gray-400 rounded focus:ring-0 focus:ring-color-indigo-50" /><label for="step-1">Add <b>"Open with Code"</b> action (both of them)</label></li><li><input onclick="return false;" checked=true type="checkbox" name="step-2" class="w-4 h-4 m-2 text-indigo-800 bg-gray-300 border-gray-400 rounded focus:ring-0 focus:ring-color-indigo-50" /><label for="step-2"><b>Register Code as an editor for supported file types</b></label></li><li><input onclick="return false;" checked=true type="checkbox" name="step-4" class="w-4 h-4 m-2 text-indigo-800 bg-gray-300 border-gray-400 rounded focus:ring-0 focus:ring-color-indigo-50" /><label for="step-3"><b>Add to PATH</b></label></li></ul>`,
