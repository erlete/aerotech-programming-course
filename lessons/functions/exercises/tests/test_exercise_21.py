...
def test():
    ...
    assert sum_up(1) == 1, "The `sum_up(1)` has the wrong return value."
    assert sum_up(1, 2) == 3, "The `sum_up(1, 2)` has the wrong return value."
    assert sum_up(2, -2) == 0, "The `sum_up(2, -2)` has the wrong return value."
    assert sum_up(False, True) == 1, "The `sum_up(True, False)` has the wrong return value."
    assert sum_up(1, True) == 2, "The `sum_up(1, True)` has the wrong return value."
